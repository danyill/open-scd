...
import { VoltageLevelViewer } from './voltage-level-viewer.js';
import { BayViewer } from './bay-viewer.js';
...
export function cloneElement(editor: BayViewer | VoltageLevelViewer): void {
